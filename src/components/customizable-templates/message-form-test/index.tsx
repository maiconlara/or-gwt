...
export const MessagesForm = () => {
    ...
    return (
        <Form {...form}>
            ...
            >
                <p className="font-poppins text-lg text-[#393939]">
                ...
                <div
                    className={`flex w-full flex-row items-center gap-10 rounded-xl py-4 pl-12 ${fonts.texts}`}
                    style={{
                        color: colors.texts,
                ...
                >
                    ...
                    <p className="max-w-[501px] cursor-default text-lg">
                ...
                <CustomButton disabled={isPending} type="submit" text="Enviar" />
            </form>
        </Form>
    );
};
